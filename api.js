...
import { nameInputElement, textInputElement, addForm, commentLoading, commentsListElements, listElement } from './utils.js';


export const fetchGetRender = () => {
    return fetch(
        'https://webdev-hw-api.vercel.app/api/v1/krasnova-vlada/comments',
        {
            method: 'GET',
        }
    )
...
export const fetchPostRender = () => {
    ...
    fetch('https://webdev-hw-api.vercel.app/api/v1/krasnova-vlada/comments', {
        method: 'POST',
        body: JSON.stringify({
